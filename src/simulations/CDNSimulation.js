...
const EDGE_LOCATIONS = [
  { id: 'JKT', name: 'Jakarta',    region: 'Asia Tenggara', latencyMs: 4   },
  { id: 'SBY', name: 'Surabaya',   region: 'Asia Tenggara', latencyMs: 10  },
  { id: 'BDG', name: 'Bandung',    region: 'Asia Tenggara', latencyMs: 12  },
  { id: 'SIN', name: 'Singapura',  region: 'Asia Tenggara', latencyMs: 18  },
  { id: 'KUL', name: 'Kuala Lumpur',region:'Asia Tenggara', latencyMs: 25  },
  { id: 'TYO', name: 'Tokyo',      region: 'Asia Timur',    latencyMs: 45  },
];
...
class CDNSimulation {
  constructor() {
    ...
    this.origin = new Map([
      ['/assets/logo-pustaka.png',    { body: { type: 'image', src: 'logo-pustaka.png',  size: '8KB'  }, contentType: 'image' }],
      ['/assets/cover-buku.jpg',  { body: { type: 'image', src: 'cover-buku.jpg',size: '310KB'}, contentType: 'image' }],
      ['/css/pustaka.css',            { body: { type: 'css',   rules: 218,              minified: true }, contentType: 'css' }],
      ['/js/katalog.js',              { body: { type: 'js',    modules: 52,             bundled: true  }, contentType: 'js'  }],
      ['/api/buku',               { body: { type: 'api',   data: [{ id: 1, judul: 'Buku Terbaru' }] }, contentType: 'api' }],
      ['/api/populer',              { body: { type: 'api',   data: [{ id: 1, judul: 'Buku Populer Minggu Ini' }]  }, contentType: 'api' }],
      ['/fonts/merriweather.woff2',         { body: { type: 'font',  family: 'Merriweather', weight: 400 },              contentType: 'font'}],
    ]);
